...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        Set<String> generalTag = new TreeSet<String>(Arrays.asList(new String[]{
        ...
        Set<String> channelTag = new TreeSet<String>(Arrays.asList(new String[]{"256", "257", "258", "259", "262", "273", "277", "278", "279", "339", "32848", "32849", "32850",
