...
// * <dd><a
// * href="http://trac.openmicroscopy.org.uk/ome/browser/bioformats.git/components/bio-formats-plugins/utils/Read_Image.java">Trac</a>,
// * <a
// * href="http://git.openmicroscopy.org/?p=bioformats.git;a=blob;f=components/bio-formats-plugins/utils/Read_Image.java;hb=HEAD">Gitweb</a></dd></dl>
// */
//public class Read_Image implements PlugIn {
//    public static void main(String[] args) {
//            // set the plugins.dir property to make the plugin appear in the Plugins menu
//            Class<?> clazz = Read_Image.class;
...
//            Logger.getLogger(Read_Image.class.getName()).log(Level.SEVERE, null, ex);
//        }
//    }
//
